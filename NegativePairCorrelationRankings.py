...
layout = html.Div([
    ...
    html.Div([
        dcc.Graph(id='our_graph_NegativePairCorrelationRankings')
    ...
    html.Div([
        ...
        dcc.Dropdown(id='my_dropdown_NegativePairCorrelationRankings',
                     options=[
...
@app.callback(
    Output(component_id='our_graph_NegativePairCorrelationRankings', component_property='figure'),
    [Input(component_id='my_dropdown_NegativePairCorrelationRankings', component_property='value')]
)
def build_graph(column_chosen):
    ...
    dat.sort_values('Correlation', ascending=False, inplace=True)
...
@app.callback(
    Output(component_id='output_data_NegativePairCorrelationRankings', component_property='children'),
    [Input(component_id='my_dropdown_NegativePairCorrelationRankings', component_property='search_value')]
)
