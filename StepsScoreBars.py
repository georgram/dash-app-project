...
layout = html.Div([
    ...
    html.Div([
        dcc.Graph(id='our_graph_StepScoreBars')
    ], className='nine columns'),

    html.Div([

        html.Br(),
        html.Div(id='output_data_StepScoreBars'),
        html.Br(),

        html.Label(['Choose column:'], style={'font-weight': 'bold', "text-align": "center"}),

        dcc.Dropdown(id='my_dropdown_StepScoreBars',
                     options=[
...
@app.callback(
    Output(component_id='our_graph_StepScoreBars', component_property='figure'),
    [Input(component_id='my_dropdown_StepScoreBars', component_property='value')]
)
...
@app.callback(
    Output(component_id='output_data_StepScoreBars', component_property='children'),
    [Input(component_id='my_dropdown_StepScoreBars', component_property='search_value')]
)
