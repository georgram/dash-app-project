...
layout = html.Div([
    ...
    html.Div([
        dcc.Graph(id='our_graph_ActorsScoreMap')
    ]),

    html.Div([

        html.Br(),
        html.Div(id='output_data_ActorsScoreMap'),
        html.Br(),
        html.Div(id='sentence_output_ActorsScoreMap'),

        html.Label(['Choose Dataset:'], style={'font-weight': 'bold', "text-align": "center"}),

        dcc.Dropdown(id='my_dropdown_ActorsScoreMap',
                     options=[
                     ...
                     value='Actors and Stakeholders Score',  # dropdown value selected automatically when page loads
...
@app.callback(
    [Output(component_id='our_graph_ActorsScoreMap', component_property='figure'), Output('sentence_output_ActorsScoreMap', 'children')],
    [Input(component_id='my_dropdown_ActorsScoreMap', component_property='value'),
     Input(component_id='my_dropdown_ActorsScoreMap', component_property='value')],
